...
public static class TaskLifeCycleHelper
{
                                                    ...
                                                    CancellationToken    cancellationToken = default)
  {
    ...
    // Delete subtasks (rather than just cancelling them) to avoid race conditions
    // and stale cancelled tasks — the retried task will recreate them from scratch.
    // This is consistent with the crash detection path in HandleTaskCrashedWhileProcessing.
